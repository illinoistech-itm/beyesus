...
sudo cp -v ./beyesus/itmo-553/week-09/graphite/graphiteb/carbon.conf /etc/carbon/carbon.conf

## Code to cp our storage aggregation configuration files and overwrite the default
sudo cp -v ./beyesus/itmo-553/week-09/graphite/graphiteb/storage-schemas.conf /etc/carbon/storage-schemas.conf
...
sudo cp -v ./beyesus/itmo-553/week-09/graphite/graphiteb/graphite-api.yaml /etc/
