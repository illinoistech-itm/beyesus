...
sudo cp -v ./beyesus/itmo-553/week-09/service-files/carbon-cache@.service /lib/systemd/system/carbon-cache@.service
sudo cp -v ./beyesus/itmo-553/week-09/service-files/carbon-relay@.service /lib/systemd/system/carbon-relay@.service

## Code to cp our carbon.conf configuration file we created and overwrite the default
sudo cp -v ./beyesus/itmo-553/week-09/graphite/graphitemc/carbon.conf /etc/carbon/carbon.conf

## Code to cp our storage aggregation configuration files and overwrite the default
sudo cp -v ./beyesus/itmo-553/week-09/graphite/graphitemc/storage-schemas.conf /etc/carbon/storage-schemas.conf
...
sudo cp -v ./beyesus/itmo-553/week-09/graphite/graphitemc/graphite-carbon.default /etc/default/graphite-carbon
...
sudo cp -v ./beyesus/itmo-553/week-09/graphite/graphitemc/graphite-api.yaml /etc/
