...
echo "%admin  ALL=NOPASSWD: ALL" | sudo cat /etc/sudoers.d/init-users
sudo groupadd admin
...
192.166.33.200  ubuntu-grahitea ubuntu-grahitea.example.com
192.166.33.201  ubuntu-grahiteb ubuntu-grahiteb.example.com
192.166.33.202  ubuntu-grahitemc ubuntu-grahitemc.example.com
